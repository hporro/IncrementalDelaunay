...
int main(int argn, char** argv){
    ...
    std::vector<Vec2> points = POINT_GENERATOR::gen_points_triangle(20,p00,p01,p02);

    Vec2 p10 = Vec2(-0.8,-0.8);
    Vec2 p11 = Vec2(0.8,-0.8);
    Vec2 p12 = Vec2(0.8,0.8);
    Vec2 p13 = Vec2(-0.8,0.8);
    std::vector<Vec2> points2 = POINT_GENERATOR::gen_points_square(12,p10,p11,p12,p13);
    std::vector<Vec2> points3 = POINT_GENERATOR::gen_points_grid(5,5,p10,p11,p12,p13);
